...
public class AsyncHttpTask extends AsyncTask<String, Void, String> {
    ...
    public String Task(String url) {
        ...
        try {
            ...
            AvLog.i("");
            conn.setRequestProperty("Content-Type", "multipart/fo" +  "" +  "" + "" + "----------------------------------------------------------rm-data;boundary=" + boundary);
            ...
            AvLog.i("name 0 = "+paramNames.get(0));
            AvLog.i("name 1 = "+paramNames.get(1));
            AvLog.i("value 0 = "+paramValues.get(0));
            AvLog.i("value 1 = "+paramValues.get(1));
            ...
            while ((str = reader.readLine()) != null) { // 서버에서 라인단위로 보내줄
                ...
                AvLog.i("builder.append(str) = "+builder.append(str));
            }
